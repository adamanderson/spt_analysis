...
ax[0].set_ylim([0,1.2])
ax[0].set_xlabel('bias frequency [MHz]', fontsize=14)
ax[0].set_ylabel('optical efficiency', fontsize=14)
ax[0].grid()
...
ax[2].set_xlabel('bolometers', fontsize=14)
