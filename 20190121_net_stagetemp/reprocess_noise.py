...
noise_obsids = [63084862, 63098693, 63218920, 63227942,
                63227942, 63305224, 63380372, 63640406, 63650590,
                63661173, 63689042, 63728180,
                64576620, 64591411, 64606397, 64685912,
                64701072, 64716070, 65041359, 65106264, 65118448,
                65134617, 65146903]
...
for jobs, obsid in enumerate(noise_obsids):
    ...
    if not os.path.exists(processed_noise_path):
        ...
        print('Observation already exists. Skipping.')
