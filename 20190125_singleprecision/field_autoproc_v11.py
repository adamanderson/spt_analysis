...
from dcsubtract import subtract_dc_offset
...
pipe.Add(subtract_dc_offset,
         ts_key_in = 'RawTimestreams_I',
         ts_key_out = 'DCSubtractedRawTimestreams_I')
...
class RemoveW201(object):
    def __init__(self, input = 'DCSubtractedRawTimestreams_I'):
        self.input = input
        self.bp = None
        self.bad_bolos=[]
...
#         flag_key = 'Flags', ts_key = 'DCSubtractedRawTimestreams_I')

# Apply calibrations
pipe.Add(std_processing.CalibrateRawTimestreams,
         i_data_key = 'DCSubtractedRawTimestreams_I',
...
# Clean-up as we go
pipe.Add(core.Delete, keys= ['RawTimestreams_I', 'DCSubtractedRawTimestreams_I', 'CalTimestreams'])
...
# #### TEST
# pipe.Add(core.Delete, keys=['CMFilteredTimestreams', 'PreCMTimestreams'])
# pipe.Add(core.Dump)
